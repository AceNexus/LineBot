...
def chat_with_groq(user_id: str, message: str, model: str = "llama-3.3-70b-versatile") -> str:
    ...
    # 記錄使用了哪個模型
    logger.info(f"Response for user {user_id} was generated by model {used_model}")
    return reply


def _trim_conversation_history(user_id: str, max_turns: int = 10) -> None:
    """
    修剪對話歷史以控制長度
